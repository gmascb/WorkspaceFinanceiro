...
//			
//			System.out.println("Lançamento: "+pagRec);
			...
			if(buscaTdo.getInt("PAGREC")+1 == pagRec || buscaTdo.getInt("PAGREC")+1 == 3)// se é igual tipo de documento e lançamento
			{
