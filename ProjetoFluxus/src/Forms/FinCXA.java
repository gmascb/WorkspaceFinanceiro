	...
	public FinCXA() {
				...
				btnSalvar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						try {
							...
							//atualiza tabela.
							novaCXA.selecionaValores(tblCxa);
	    ...
	    btnAtualiza.addActionListener(new ActionListener() {
	    	public void actionPerformed(ActionEvent arg0) {
				...
				novoCxa.setDescricao(txtDesc.getText());
				novoCxa.atualiza(tblCxa);
	    	
				//limpa os campos depois de realizado.
				txtCodigo.setText("");
				txtDesc.setText("");
				txtSaldoinicial.setText("0.00");
