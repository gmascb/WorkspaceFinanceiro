	...
	public FinCFO() {
			...
			buttonPane.setLayout(new FlowLayout(FlowLayout.RIGHT));
			{
				...
				btnInsert.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						try {
							// cria instancia que será incluida no banco.
				...
				btnEditar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						try {
							//cria conexão para pegar os campos do cli/for
							Conexao acessaBanco = new Conexao();
							
							//busca os dados do cliente e pôe os mesmos no objeto rs.
		...
		btnAtualizar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				//desaparece botão para salvar o Editado.
				...
				//atualiza os novos dados para o objeto que será atualizado.
		...
		btnCancelar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//volta com o campo como habilitado para edição.
				txtcodcfo.setEnabled(true);
